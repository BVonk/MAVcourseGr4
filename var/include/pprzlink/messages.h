...
#define DL_GPS_RXMRTCM 230
#define PPRZ_MSG_ID_GPS_RXMRTCM 230
...
#define DL_MSG_telemetry_NB 252
...
static inline void pprz_msg_send_VECTORNAV_INFO(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, float *_timestamp, uint32_t *_chksm_error, uint32_t *_hdr_error, uint16_t *_rate, uint8_t *_ins_status, uint8_t *_ins_err, float *_YprU1, float *_YprU2, float *_YprU3) {
  ...
  if (trans->check_available_space(trans->impl, dev, _FD_ADDR, trans->size_of(trans->impl, 0+4+4+4+2+1+1+4+4+4 +2 /* msg header overhead */))) {
    ...
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT16, DL_FORMAT_SCALAR, (void *) _rate, 2);
...
static inline void pprz_msg_send_SYS_MON(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, uint16_t *_periodic_time, uint16_t *_periodic_time_min, uint16_t *_periodic_time_max, uint16_t *_periodic_cycle, uint16_t *_periodic_cycle_min, uint16_t *_periodic_cycle_max, uint16_t *_event_number, uint8_t *_cpu_load, float *_cpu_time) {
  ...
  long _FD = 0; /* can be an address, an index, a file descriptor, ... */
#endif
  if (trans->check_available_space(trans->impl, dev, _FD_ADDR, trans->size_of(trans->impl, 0+2+2+2+2+2+2+2+1+4 +2 /* msg header overhead */))) {
    trans->count_bytes(trans->impl, dev, trans->size_of(trans->impl, 0+2+2+2+2+2+2+2+1+4 +2 /* msg header overhead */));
    trans->start_message(trans->impl, dev, _FD, 0+2+2+2+2+2+2+2+1+4 +2 /* msg header overhead */);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, &ac_id, 1);
    ...
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _cpu_time, 4);
    trans->end_message(trans->impl, dev, _FD);
  } else
    trans->overrun(trans->impl, dev);
}
...
static inline void pprz_msg_send_BARO_BMP85_CALIB(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, int16_t *_a1, int16_t *_a2, int16_t *_a3, uint16_t *_a4, uint16_t *_a5, uint16_t *_a6, int16_t *_b1, int16_t *_b2, int16_t *_mb, int16_t *_mc, int16_t *_md) {
  ...
  long _FD = 0; /* can be an address, an index, a file descriptor, ... */
#endif
  if (trans->check_available_space(trans->impl, dev, _FD_ADDR, trans->size_of(trans->impl, 0+2+2+2+2+2+2+2+2+2+2+2 +2 /* msg header overhead */))) {
    trans->count_bytes(trans->impl, dev, trans->size_of(trans->impl, 0+2+2+2+2+2+2+2+2+2+2+2 +2 /* msg header overhead */));
    trans->start_message(trans->impl, dev, _FD, 0+2+2+2+2+2+2+2+2+2+2+2 +2 /* msg header overhead */);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, &ac_id, 1);
    trans->put_named_byte(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, DL_BARO_BMP85_CALIB, "BARO_BMP85_CALIB");
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_INT16, DL_FORMAT_SCALAR, (void *) _a1, 2);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_INT16, DL_FORMAT_SCALAR, (void *) _a2, 2);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_INT16, DL_FORMAT_SCALAR, (void *) _a3, 2);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT16, DL_FORMAT_SCALAR, (void *) _a4, 2);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT16, DL_FORMAT_SCALAR, (void *) _a5, 2);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT16, DL_FORMAT_SCALAR, (void *) _a6, 2);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_INT16, DL_FORMAT_SCALAR, (void *) _b1, 2);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_INT16, DL_FORMAT_SCALAR, (void *) _b2, 2);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_INT16, DL_FORMAT_SCALAR, (void *) _mb, 2);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_INT16, DL_FORMAT_SCALAR, (void *) _mc, 2);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_INT16, DL_FORMAT_SCALAR, (void *) _md, 2);
    trans->end_message(trans->impl, dev, _FD);
  } else
    trans->overrun(trans->impl, dev);
}
...
static inline void pprz_msg_send_BARO_BMP85(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, int32_t *_UT, int32_t *_UP, uint32_t *_P, float *_T, float *_MSL) {
  ...
  if (trans->check_available_space(trans->impl, dev, _FD_ADDR, trans->size_of(trans->impl, 0+4+4+4+4+4 +2 /* msg header overhead */))) {
    ...
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, &ac_id, 1);
    trans->put_named_byte(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, DL_BARO_BMP85, "BARO_BMP85");
    ...
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT32, DL_FORMAT_SCALAR, (void *) _P, 4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _T, 4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _MSL, 4);
    trans->end_message(trans->impl, dev, _FD);
  } else
    trans->overrun(trans->impl, dev);
}
...
#define DOWNLINK_SEND_GVF(_trans, _dev, error, traj, s, nb_p, p) pprz_msg_send_GVF(&((_trans).trans_tx), &((_dev).device), AC_ID, error, traj, s, nb_p, p)
static inline void pprz_msg_send_GVF(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, float *_error, uint8_t *_traj, int8_t *_s, uint8_t nb_p, float *_p) {
#if PPRZLINK_ENABLE_FD
  long _FD = 0; /* can be an address, an index, a file descriptor, ... */
#endif
  if (trans->check_available_space(trans->impl, dev, _FD_ADDR, trans->size_of(trans->impl, 0+4+1+1+1+nb_p*4 +2 /* msg header overhead */))) {
    trans->count_bytes(trans->impl, dev, trans->size_of(trans->impl, 0+4+1+1+1+nb_p*4 +2 /* msg header overhead */));
    trans->start_message(trans->impl, dev, _FD, 0+4+1+1+1+nb_p*4 +2 /* msg header overhead */);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, &ac_id, 1);
    trans->put_named_byte(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, DL_GVF, "GVF");
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _error, 4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, (void *) _traj, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_INT8, DL_FORMAT_SCALAR, (void *) _s, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_ARRAY_LENGTH, DL_FORMAT_SCALAR, (void *) &nb_p, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_FLOAT, DL_FORMAT_ARRAY, (void *) _p, nb_p*4);
    trans->end_message(trans->impl, dev, _FD);
  } else
    trans->overrun(trans->impl, dev);
}
...
static inline void pprz_msg_send_MISSION_STATUS(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, float *_remaining_time, uint8_t nb_index_list, uint8_t *_index_list) {
  ...
  long _FD = 0; /* can be an address, an index, a file descriptor, ... */
#endif
  if (trans->check_available_space(trans->impl, dev, _FD_ADDR, trans->size_of(trans->impl, 0+4+1+nb_index_list*1 +2 /* msg header overhead */))) {
    trans->count_bytes(trans->impl, dev, trans->size_of(trans->impl, 0+4+1+nb_index_list*1 +2 /* msg header overhead */));
    trans->start_message(trans->impl, dev, _FD, 0+4+1+nb_index_list*1 +2 /* msg header overhead */);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, &ac_id, 1);
    ...
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_ARRAY_LENGTH, DL_FORMAT_SCALAR, (void *) &nb_index_list, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_ARRAY, (void *) _index_list, nb_index_list*1);
    trans->end_message(trans->impl, dev, _FD);
  } else
    trans->overrun(trans->impl, dev);
}
...
static inline void pprz_msg_send_THROTTLE_CURVE(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, uint8_t *_curve, uint16_t *_throttle, int16_t *_collective, uint16_t *_rpm_sp, uint16_t *_rpm_meas, float *_rpm_err_sum) {
  ...
  long _FD = 0; /* can be an address, an index, a file descriptor, ... */
#endif
  if (trans->check_available_space(trans->impl, dev, _FD_ADDR, trans->size_of(trans->impl, 0+1+2+2+2+2+4 +2 /* msg header overhead */))) {
    trans->count_bytes(trans->impl, dev, trans->size_of(trans->impl, 0+1+2+2+2+2+4 +2 /* msg header overhead */));
    trans->start_message(trans->impl, dev, _FD, 0+1+2+2+2+2+4 +2 /* msg header overhead */);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, &ac_id, 1);
    trans->put_named_byte(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, DL_THROTTLE_CURVE, "THROTTLE_CURVE");
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, (void *) _curve, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT16, DL_FORMAT_SCALAR, (void *) _throttle, 2);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_INT16, DL_FORMAT_SCALAR, (void *) _collective, 2);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT16, DL_FORMAT_SCALAR, (void *) _rpm_sp, 2);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT16, DL_FORMAT_SCALAR, (void *) _rpm_meas, 2);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _rpm_err_sum, 4);
    trans->end_message(trans->impl, dev, _FD);
  } else
    trans->overrun(trans->impl, dev);
}
...
static inline void pprz_msg_send_MOTOR_MIXING(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, uint8_t nb_values, int16_t *_values) {
  ...
  if (trans->check_available_space(trans->impl, dev, _FD_ADDR, trans->size_of(trans->impl, 0+1+nb_values*2 +2 /* msg header overhead */))) {
    ...
    trans->start_message(trans->impl, dev, _FD, 0+1+nb_values*2 +2 /* msg header overhead */);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, &ac_id, 1);
    trans->put_named_byte(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, DL_MOTOR_MIXING, "MOTOR_MIXING");
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_ARRAY_LENGTH, DL_FORMAT_SCALAR, (void *) &nb_values, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_INT16, DL_FORMAT_ARRAY, (void *) _values, nb_values*2);
    trans->end_message(trans->impl, dev, _FD);
  } else
...
static inline void pprz_msg_send_ROTORCRAFT_FP_MIN(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, int32_t *_east, int32_t *_north, int32_t *_up, uint16_t *_gspeed) {
  ...
  if (trans->check_available_space(trans->impl, dev, _FD_ADDR, trans->size_of(trans->impl, 0+4+4+4+2 +2 /* msg header overhead */))) {
    ...
    trans->start_message(trans->impl, dev, _FD, 0+4+4+4+2 +2 /* msg header overhead */);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, &ac_id, 1);
    trans->put_named_byte(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, DL_ROTORCRAFT_FP_MIN, "ROTORCRAFT_FP_MIN");
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_INT32, DL_FORMAT_SCALAR, (void *) _east, 4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_INT32, DL_FORMAT_SCALAR, (void *) _north, 4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_INT32, DL_FORMAT_SCALAR, (void *) _up, 4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT16, DL_FORMAT_SCALAR, (void *) _gspeed, 2);
...
static inline void pprz_msg_send_GPS_RXMRTCM(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, uint32_t *_Msg1005, uint32_t *_Msg1077, uint32_t *_Msg1087, uint32_t *_Crc1005, uint32_t *_Crc1077, uint32_t *_Crc1087) {
  ...
  if (trans->check_available_space(trans->impl, dev, _FD_ADDR, trans->size_of(trans->impl, 0+4+4+4+4+4+4 +2 /* msg header overhead */))) {
    ...
    trans->start_message(trans->impl, dev, _FD, 0+4+4+4+4+4+4 +2 /* msg header overhead */);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, &ac_id, 1);
    trans->put_named_byte(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, DL_GPS_RXMRTCM, "GPS_RXMRTCM");
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT32, DL_FORMAT_SCALAR, (void *) _Msg1005, 4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT32, DL_FORMAT_SCALAR, (void *) _Msg1077, 4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT32, DL_FORMAT_SCALAR, (void *) _Msg1087, 4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT32, DL_FORMAT_SCALAR, (void *) _Crc1005, 4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT32, DL_FORMAT_SCALAR, (void *) _Crc1077, 4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT32, DL_FORMAT_SCALAR, (void *) _Crc1087, 4);
    trans->end_message(trans->impl, dev, _FD);
  } else
    trans->overrun(trans->impl, dev);
}
...
static inline void pprz_msg_send_PX4FLOW(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, float *_time_sec, uint8_t *_sensor_id, int16_t *_flow_x, int16_t *_flow_y, float *_flow_comp_m_x, float *_flow_comp_m_y, uint8_t *_quality, float *_ground_distance) {
  ...
  long _FD = 0; /* can be an address, an index, a file descriptor, ... */
#endif
  if (trans->check_available_space(trans->impl, dev, _FD_ADDR, trans->size_of(trans->impl, 0+4+1+2+2+4+4+1+4 +2 /* msg header overhead */))) {
    trans->count_bytes(trans->impl, dev, trans->size_of(trans->impl, 0+4+1+2+2+4+4+1+4 +2 /* msg header overhead */));
    trans->start_message(trans->impl, dev, _FD, 0+4+1+2+2+4+4+1+4 +2 /* msg header overhead */);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, &ac_id, 1);
    trans->put_named_byte(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, DL_PX4FLOW, "PX4FLOW");
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _time_sec, 4);
...
static inline void pprz_msg_send_LIDAR(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, float *_distance, uint8_t *_status, uint8_t *_trans_status) {
  ...
  long _FD = 0; /* can be an address, an index, a file descriptor, ... */
#endif
  if (trans->check_available_space(trans->impl, dev, _FD_ADDR, trans->size_of(trans->impl, 0+4+1+1 +2 /* msg header overhead */))) {
    trans->count_bytes(trans->impl, dev, trans->size_of(trans->impl, 0+4+1+1 +2 /* msg header overhead */));
    trans->start_message(trans->impl, dev, _FD, 0+4+1+1 +2 /* msg header overhead */);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, &ac_id, 1);
    trans->put_named_byte(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, DL_LIDAR, "LIDAR");
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _distance, 4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, (void *) _status, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, (void *) _trans_status, 1);
    trans->end_message(trans->impl, dev, _FD);
  } else
    trans->overrun(trans->impl, dev);
}
...
#define DOWNLINK_SEND_RTOS_MON(_trans, _dev, nb_threads, cpu_load, core_free, heap_free, cpu_time) pprz_msg_send_RTOS_MON(&((_trans).trans_tx), &((_dev).device), AC_ID, nb_threads, cpu_load, core_free, heap_free, cpu_time)
static inline void pprz_msg_send_RTOS_MON(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, uint8_t *_nb_threads, uint8_t *_cpu_load, uint32_t *_core_free, uint32_t *_heap_free, float *_cpu_time) {
#if PPRZLINK_ENABLE_FD
  long _FD = 0; /* can be an address, an index, a file descriptor, ... */
#endif
  if (trans->check_available_space(trans->impl, dev, _FD_ADDR, trans->size_of(trans->impl, 0+1+1+4+4+4 +2 /* msg header overhead */))) {
...
static inline void pprz_msg_send_BATTERY_MONITOR(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, uint8_t *_version, uint8_t *_bus_dev_stat, uint8_t *_bus_trans_stat, uint16_t *_current_raw, float *_current, uint16_t *_bus_voltage, uint8_t nb_bus_temp_raw, uint16_t *_bus_temp_raw, uint8_t nb_bus_temp, float *_bus_temp, uint8_t *_bal1_trans_stat, uint8_t nb_bal1_cells, uint16_t *_bal1_cells, uint8_t *_bal2_trans_stat, uint8_t nb_bal2_cells, uint16_t *_bal2_cells, uint16_t *_safety_plug) {
  ...
  long _FD = 0; /* can be an address, an index, a file descriptor, ... */
#endif
  if (trans->check_available_space(trans->impl, dev, _FD_ADDR, trans->size_of(trans->impl, 0+1+1+1+2+4+2+1+nb_bus_temp_raw*2+1+nb_bus_temp*4+1+1+nb_bal1_cells*2+1+1+nb_bal2_cells*2+2 +2 /* msg header overhead */))) {
    trans->count_bytes(trans->impl, dev, trans->size_of(trans->impl, 0+1+1+1+2+4+2+1+nb_bus_temp_raw*2+1+nb_bus_temp*4+1+1+nb_bal1_cells*2+1+1+nb_bal2_cells*2+2 +2 /* msg header overhead */));
    trans->start_message(trans->impl, dev, _FD, 0+1+1+1+2+4+2+1+nb_bus_temp_raw*2+1+nb_bus_temp*4+1+1+nb_bal1_cells*2+1+1+nb_bal2_cells*2+2 +2 /* msg header overhead */);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, &ac_id, 1);
    trans->put_named_byte(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, DL_BATTERY_MONITOR, "BATTERY_MONITOR");
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, (void *) _version, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, (void *) _bus_dev_stat, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, (void *) _bus_trans_stat, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT16, DL_FORMAT_SCALAR, (void *) _current_raw, 2);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _current, 4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT16, DL_FORMAT_SCALAR, (void *) _bus_voltage, 2);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_ARRAY_LENGTH, DL_FORMAT_SCALAR, (void *) &nb_bus_temp_raw, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT16, DL_FORMAT_ARRAY, (void *) _bus_temp_raw, nb_bus_temp_raw*2);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_ARRAY_LENGTH, DL_FORMAT_SCALAR, (void *) &nb_bus_temp, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_FLOAT, DL_FORMAT_ARRAY, (void *) _bus_temp, nb_bus_temp*4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, (void *) _bal1_trans_stat, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_ARRAY_LENGTH, DL_FORMAT_SCALAR, (void *) &nb_bal1_cells, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT16, DL_FORMAT_ARRAY, (void *) _bal1_cells, nb_bal1_cells*2);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, (void *) _bal2_trans_stat, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_ARRAY_LENGTH, DL_FORMAT_SCALAR, (void *) &nb_bal2_cells, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT16, DL_FORMAT_ARRAY, (void *) _bal2_cells, nb_bal2_cells*2);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT16, DL_FORMAT_SCALAR, (void *) _safety_plug, 2);
    trans->end_message(trans->impl, dev, _FD);
  } else
    trans->overrun(trans->impl, dev);
}
...
static inline void pprz_msg_send_INDI_G(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, uint8_t nb_G1_roll, float *_G1_roll, uint8_t nb_G1_pitch, float *_G1_pitch, uint8_t nb_G1_yaw, float *_G1_yaw, uint8_t nb_G1_thrust, float *_G1_thrust, uint8_t nb_G2, float *_G2) {
  ...
  long _FD = 0; /* can be an address, an index, a file descriptor, ... */
#endif
  if (trans->check_available_space(trans->impl, dev, _FD_ADDR, trans->size_of(trans->impl, 0+1+nb_G1_roll*4+1+nb_G1_pitch*4+1+nb_G1_yaw*4+1+nb_G1_thrust*4+1+nb_G2*4 +2 /* msg header overhead */))) {
    trans->count_bytes(trans->impl, dev, trans->size_of(trans->impl, 0+1+nb_G1_roll*4+1+nb_G1_pitch*4+1+nb_G1_yaw*4+1+nb_G1_thrust*4+1+nb_G2*4 +2 /* msg header overhead */));
    trans->start_message(trans->impl, dev, _FD, 0+1+nb_G1_roll*4+1+nb_G1_pitch*4+1+nb_G1_yaw*4+1+nb_G1_thrust*4+1+nb_G2*4 +2 /* msg header overhead */);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, &ac_id, 1);
    trans->put_named_byte(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, DL_INDI_G, "INDI_G");
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_ARRAY_LENGTH, DL_FORMAT_SCALAR, (void *) &nb_G1_roll, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_FLOAT, DL_FORMAT_ARRAY, (void *) _G1_roll, nb_G1_roll*4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_ARRAY_LENGTH, DL_FORMAT_SCALAR, (void *) &nb_G1_pitch, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_FLOAT, DL_FORMAT_ARRAY, (void *) _G1_pitch, nb_G1_pitch*4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_ARRAY_LENGTH, DL_FORMAT_SCALAR, (void *) &nb_G1_yaw, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_FLOAT, DL_FORMAT_ARRAY, (void *) _G1_yaw, nb_G1_yaw*4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_ARRAY_LENGTH, DL_FORMAT_SCALAR, (void *) &nb_G1_thrust, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_FLOAT, DL_FORMAT_ARRAY, (void *) _G1_thrust, nb_G1_thrust*4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_ARRAY_LENGTH, DL_FORMAT_SCALAR, (void *) &nb_G2, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_FLOAT, DL_FORMAT_ARRAY, (void *) _G2, nb_G2*4);
    trans->end_message(trans->impl, dev, _FD);
  } else
    trans->overrun(trans->impl, dev);
}
...
static inline void pprz_msg_send_GPS_RTK(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, uint32_t *_iTOW, uint16_t *_refStationId, int32_t *_relPosN, int32_t *_relPosE, int32_t *_relPosD, int8_t *_relPosHPN, int8_t *_relPosHPE, int8_t *_relPosHPD, uint32_t *_accN, uint32_t *_accE, uint32_t *_accD, uint8_t *_carrSoln, uint8_t *_relPosValid, uint8_t *_diffSoln, uint8_t *_gnssFixOK) {
  ...
  long _FD = 0; /* can be an address, an index, a file descriptor, ... */
#endif
  if (trans->check_available_space(trans->impl, dev, _FD_ADDR, trans->size_of(trans->impl, 0+4+2+4+4+4+1+1+1+4+4+4+1+1+1+1 +2 /* msg header overhead */))) {
    trans->count_bytes(trans->impl, dev, trans->size_of(trans->impl, 0+4+2+4+4+4+1+1+1+4+4+4+1+1+1+1 +2 /* msg header overhead */));
    trans->start_message(trans->impl, dev, _FD, 0+4+2+4+4+4+1+1+1+4+4+4+1+1+1+1 +2 /* msg header overhead */);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, &ac_id, 1);
    trans->put_named_byte(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, DL_GPS_RTK, "GPS_RTK");
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT32, DL_FORMAT_SCALAR, (void *) _iTOW, 4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT16, DL_FORMAT_SCALAR, (void *) _refStationId, 2);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_INT32, DL_FORMAT_SCALAR, (void *) _relPosN, 4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_INT32, DL_FORMAT_SCALAR, (void *) _relPosE, 4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_INT32, DL_FORMAT_SCALAR, (void *) _relPosD, 4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_INT8, DL_FORMAT_SCALAR, (void *) _relPosHPN, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_INT8, DL_FORMAT_SCALAR, (void *) _relPosHPE, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_INT8, DL_FORMAT_SCALAR, (void *) _relPosHPD, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT32, DL_FORMAT_SCALAR, (void *) _accN, 4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT32, DL_FORMAT_SCALAR, (void *) _accE, 4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT32, DL_FORMAT_SCALAR, (void *) _accD, 4);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, (void *) _carrSoln, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, (void *) _relPosValid, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, (void *) _diffSoln, 1);
    trans->put_bytes(trans->impl, dev, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, (void *) _gnssFixOK, 1);
    trans->end_message(trans->impl, dev, _FD);
  } else
    trans->overrun(trans->impl, dev);
}
...
static inline void pprz_send_msg_BARO_BMP85_CALIB(struct transport_tx *trans __attribute__((unused)), struct link_device *dev __attribute__((unused)), uint8_t ac_id __attribute__((unused)), int16_t *_a1 __attribute__((unused)), int16_t *_a2 __attribute__((unused)), int16_t *_a3 __attribute__((unused)), uint16_t *_a4 __attribute__((unused)), uint16_t *_a5 __attribute__((unused)), uint16_t *_a6 __attribute__((unused)), int16_t *_b1 __attribute__((unused)), int16_t *_b2 __attribute__((unused)), int16_t *_mb __attribute__((unused)), int16_t *_mc __attribute__((unused)), int16_t *_md __attribute__((unused))) {}

#define DOWNLINK_SEND_BARO_BMP85(_trans, _dev, UT, UP, P, T, MSL) {}
static inline void pprz_send_msg_BARO_BMP85(struct transport_tx *trans __attribute__((unused)), struct link_device *dev __attribute__((unused)), uint8_t ac_id __attribute__((unused)), int32_t *_UT __attribute__((unused)), int32_t *_UP __attribute__((unused)), uint32_t *_P __attribute__((unused)), float *_T __attribute__((unused)), float *_MSL __attribute__((unused))) {}
...
#define DOWNLINK_SEND_GVF(_trans, _dev, error, traj, s, nb_p, p) {}
static inline void pprz_send_msg_GVF(struct transport_tx *trans __attribute__((unused)), struct link_device *dev __attribute__((unused)), uint8_t ac_id __attribute__((unused)), float *_error __attribute__((unused)), uint8_t *_traj __attribute__((unused)), int8_t *_s __attribute__((unused)), uint8_t nb_p __attribute__((unused)), float *_p __attribute__((unused))) {}
...
#define DOWNLINK_SEND_RTOS_MON(_trans, _dev, nb_threads, cpu_load, core_free, heap_free, cpu_time) {}
static inline void pprz_send_msg_RTOS_MON(struct transport_tx *trans __attribute__((unused)), struct link_device *dev __attribute__((unused)), uint8_t ac_id __attribute__((unused)), uint8_t *_nb_threads __attribute__((unused)), uint8_t *_cpu_load __attribute__((unused)), uint32_t *_core_free __attribute__((unused)), uint32_t *_heap_free __attribute__((unused)), float *_cpu_time __attribute__((unused))) {}
...
#define DL_VECTORNAV_INFO_rate(_payload) _PPRZ_VAL_uint16_t(_payload, 14)
...
#define DL_SYS_MON_cpu_time(_payload) _PPRZ_VAL_float(_payload, 17)
...
#define DL_BARO_BMP85_CALIB_a1(_payload) _PPRZ_VAL_int16_t(_payload, 2)
#define DL_BARO_BMP85_CALIB_a2(_payload) _PPRZ_VAL_int16_t(_payload, 4)
#define DL_BARO_BMP85_CALIB_a3(_payload) _PPRZ_VAL_int16_t(_payload, 6)
#define DL_BARO_BMP85_CALIB_a4(_payload) _PPRZ_VAL_uint16_t(_payload, 8)
#define DL_BARO_BMP85_CALIB_a5(_payload) _PPRZ_VAL_uint16_t(_payload, 10)
#define DL_BARO_BMP85_CALIB_a6(_payload) _PPRZ_VAL_uint16_t(_payload, 12)
#define DL_BARO_BMP85_CALIB_b1(_payload) _PPRZ_VAL_int16_t(_payload, 14)
#define DL_BARO_BMP85_CALIB_b2(_payload) _PPRZ_VAL_int16_t(_payload, 16)
#define DL_BARO_BMP85_CALIB_mb(_payload) _PPRZ_VAL_int16_t(_payload, 18)
#define DL_BARO_BMP85_CALIB_mc(_payload) _PPRZ_VAL_int16_t(_payload, 20)
#define DL_BARO_BMP85_CALIB_md(_payload) _PPRZ_VAL_int16_t(_payload, 22)

#define DL_BARO_BMP85_UT(_payload) _PPRZ_VAL_int32_t(_payload, 2)
#define DL_BARO_BMP85_UP(_payload) _PPRZ_VAL_int32_t(_payload, 6)
#define DL_BARO_BMP85_P(_payload) _PPRZ_VAL_uint32_t(_payload, 10)
#define DL_BARO_BMP85_T(_payload) _PPRZ_VAL_float(_payload, 14)
#define DL_BARO_BMP85_MSL(_payload) _PPRZ_VAL_float(_payload, 18)
...
#define DL_GVF_error(_payload) _PPRZ_VAL_float(_payload, 2)
#define DL_GVF_traj(_payload) _PPRZ_VAL_uint8_t(_payload, 6)
#define DL_GVF_s(_payload) _PPRZ_VAL_int8_t(_payload, 7)
#define DL_GVF_p_length(_payload) _PPRZ_VAL_len_aligned(_payload, 8)
#define DL_GVF_p(_payload) _PPRZ_VAL_float_array(_payload, 9)
...
#define DL_MISSION_STATUS_index_list_length(_payload) _PPRZ_VAL_uint8_t(_payload, 6)
#define DL_MISSION_STATUS_index_list(_payload) _PPRZ_VAL_uint8_t_array(_payload, 7)
...
#define DL_THROTTLE_CURVE_curve(_payload) _PPRZ_VAL_uint8_t(_payload, 2)
#define DL_THROTTLE_CURVE_throttle(_payload) _PPRZ_VAL_uint16_t(_payload, 3)
#define DL_THROTTLE_CURVE_collective(_payload) _PPRZ_VAL_int16_t(_payload, 5)
#define DL_THROTTLE_CURVE_rpm_sp(_payload) _PPRZ_VAL_uint16_t(_payload, 7)
#define DL_THROTTLE_CURVE_rpm_meas(_payload) _PPRZ_VAL_uint16_t(_payload, 9)
#define DL_THROTTLE_CURVE_rpm_err_sum(_payload) _PPRZ_VAL_float(_payload, 11)
...
#define DL_MOTOR_MIXING_values_length(_payload) _PPRZ_VAL_len_aligned(_payload, 2)
#define DL_MOTOR_MIXING_values(_payload) _PPRZ_VAL_int16_t_array(_payload, 3)
...
#define DL_ROTORCRAFT_FP_MIN_east(_payload) _PPRZ_VAL_int32_t(_payload, 2)
#define DL_ROTORCRAFT_FP_MIN_north(_payload) _PPRZ_VAL_int32_t(_payload, 6)
#define DL_ROTORCRAFT_FP_MIN_up(_payload) _PPRZ_VAL_int32_t(_payload, 10)
#define DL_ROTORCRAFT_FP_MIN_gspeed(_payload) _PPRZ_VAL_uint16_t(_payload, 14)
...
#define DL_GPS_RXMRTCM_Msg1005(_payload) _PPRZ_VAL_uint32_t(_payload, 2)
#define DL_GPS_RXMRTCM_Msg1077(_payload) _PPRZ_VAL_uint32_t(_payload, 6)
#define DL_GPS_RXMRTCM_Msg1087(_payload) _PPRZ_VAL_uint32_t(_payload, 10)
#define DL_GPS_RXMRTCM_Crc1005(_payload) _PPRZ_VAL_uint32_t(_payload, 14)
#define DL_GPS_RXMRTCM_Crc1077(_payload) _PPRZ_VAL_uint32_t(_payload, 18)
#define DL_GPS_RXMRTCM_Crc1087(_payload) _PPRZ_VAL_uint32_t(_payload, 22)
...
#define DL_PX4FLOW_time_sec(_payload) _PPRZ_VAL_float(_payload, 2)
#define DL_PX4FLOW_sensor_id(_payload) _PPRZ_VAL_uint8_t(_payload, 6)
#define DL_PX4FLOW_flow_x(_payload) _PPRZ_VAL_int16_t(_payload, 7)
#define DL_PX4FLOW_flow_y(_payload) _PPRZ_VAL_int16_t(_payload, 9)
#define DL_PX4FLOW_flow_comp_m_x(_payload) _PPRZ_VAL_float(_payload, 11)
#define DL_PX4FLOW_flow_comp_m_y(_payload) _PPRZ_VAL_float(_payload, 15)
#define DL_PX4FLOW_quality(_payload) _PPRZ_VAL_uint8_t(_payload, 19)
#define DL_PX4FLOW_ground_distance(_payload) _PPRZ_VAL_float(_payload, 20)

#define DL_LIDAR_distance(_payload) _PPRZ_VAL_float(_payload, 2)
#define DL_LIDAR_status(_payload) _PPRZ_VAL_uint8_t(_payload, 6)
#define DL_LIDAR_trans_status(_payload) _PPRZ_VAL_uint8_t(_payload, 7)
...
#define DL_RTOS_MON_cpu_time(_payload) _PPRZ_VAL_float(_payload, 12)
...
#define DL_BATTERY_MONITOR_version(_payload) _PPRZ_VAL_uint8_t(_payload, 2)
#define DL_BATTERY_MONITOR_bus_dev_stat(_payload) _PPRZ_VAL_uint8_t(_payload, 3)
#define DL_BATTERY_MONITOR_bus_trans_stat(_payload) _PPRZ_VAL_uint8_t(_payload, 4)
#define DL_BATTERY_MONITOR_current_raw(_payload) _PPRZ_VAL_uint16_t(_payload, 5)
#define DL_BATTERY_MONITOR_current(_payload) _PPRZ_VAL_float(_payload, 7)
#define DL_BATTERY_MONITOR_bus_voltage(_payload) _PPRZ_VAL_uint16_t(_payload, 11)
#define DL_BATTERY_MONITOR_bus_temp_raw_length(_payload) _PPRZ_VAL_uint8_t(_payload, 13)
#define DL_BATTERY_MONITOR_bus_temp_raw(_payload) _PPRZ_VAL_uint16_t_array(_payload, 14)
#define DL_BATTERY_MONITOR_bus_temp_length(_payload) _PPRZ_VAL_len_aligned(_payload, 14)
#define DL_BATTERY_MONITOR_bus_temp(_payload) _PPRZ_VAL_float_array(_payload, 15)
#define DL_BATTERY_MONITOR_bal1_trans_stat(_payload) _PPRZ_VAL_uint8_t(_payload, 15)
#define DL_BATTERY_MONITOR_bal1_cells_length(_payload) _PPRZ_VAL_len_aligned(_payload, 16)
#define DL_BATTERY_MONITOR_bal1_cells(_payload) _PPRZ_VAL_uint16_t_array(_payload, 17)
#define DL_BATTERY_MONITOR_bal2_trans_stat(_payload) _PPRZ_VAL_uint8_t(_payload, 17)
#define DL_BATTERY_MONITOR_bal2_cells_length(_payload) _PPRZ_VAL_len_aligned(_payload, 18)
#define DL_BATTERY_MONITOR_bal2_cells(_payload) _PPRZ_VAL_uint16_t_array(_payload, 19)
#define DL_BATTERY_MONITOR_safety_plug(_payload) _PPRZ_VAL_uint16_t(_payload, 19)

#define DL_INDI_G_G1_roll_length(_payload) _PPRZ_VAL_len_aligned(_payload, 2)
#define DL_INDI_G_G1_roll(_payload) _PPRZ_VAL_float_array(_payload, 3)
#define DL_INDI_G_G1_pitch_length(_payload) _PPRZ_VAL_uint8_t(_payload, 3)
#define DL_INDI_G_G1_pitch(_payload) _PPRZ_VAL_float_array(_payload, 4)
#define DL_INDI_G_G1_yaw_length(_payload) _PPRZ_VAL_len_aligned(_payload, 4)
#define DL_INDI_G_G1_yaw(_payload) _PPRZ_VAL_float_array(_payload, 5)
#define DL_INDI_G_G1_thrust_length(_payload) _PPRZ_VAL_len_aligned(_payload, 5)
#define DL_INDI_G_G1_thrust(_payload) _PPRZ_VAL_float_array(_payload, 6)
#define DL_INDI_G_G2_length(_payload) _PPRZ_VAL_len_aligned(_payload, 6)
#define DL_INDI_G_G2(_payload) _PPRZ_VAL_float_array(_payload, 7)

#define DL_GPS_RTK_iTOW(_payload) _PPRZ_VAL_uint32_t(_payload, 2)
#define DL_GPS_RTK_refStationId(_payload) _PPRZ_VAL_uint16_t(_payload, 6)
#define DL_GPS_RTK_relPosN(_payload) _PPRZ_VAL_int32_t(_payload, 8)
#define DL_GPS_RTK_relPosE(_payload) _PPRZ_VAL_int32_t(_payload, 12)
#define DL_GPS_RTK_relPosD(_payload) _PPRZ_VAL_int32_t(_payload, 16)
#define DL_GPS_RTK_relPosHPN(_payload) _PPRZ_VAL_int8_t(_payload, 20)
#define DL_GPS_RTK_relPosHPE(_payload) _PPRZ_VAL_int8_t(_payload, 21)
#define DL_GPS_RTK_relPosHPD(_payload) _PPRZ_VAL_int8_t(_payload, 22)
#define DL_GPS_RTK_accN(_payload) _PPRZ_VAL_uint32_t(_payload, 23)
#define DL_GPS_RTK_accE(_payload) _PPRZ_VAL_uint32_t(_payload, 27)
#define DL_GPS_RTK_accD(_payload) _PPRZ_VAL_uint32_t(_payload, 31)
#define DL_GPS_RTK_carrSoln(_payload) _PPRZ_VAL_uint8_t(_payload, 35)
#define DL_GPS_RTK_relPosValid(_payload) _PPRZ_VAL_uint8_t(_payload, 36)
#define DL_GPS_RTK_diffSoln(_payload) _PPRZ_VAL_uint8_t(_payload, 37)
#define DL_GPS_RTK_gnssFixOK(_payload) _PPRZ_VAL_uint8_t(_payload, 38)
