/* Generated by gen_xsens from /home/bart/paparazzi/conf/xsens_MTi-G.xml */
/* Please DO NOT EDIT */
...
#define XSENS_SetSyncOutSettings_ID 0xD8
#define XSENS_SetSyncOutSettings(param,value) { \
  XsensHeader(XSENS_SetSyncOutSettings_ID, 3);\
  uint8_t _param = param; XsensSend1ByAddr((uint8_t*)&_param);\
  uint16_t _value = value; XsensSend2ByAddr((uint8_t*)&_value);\
  XsensTrailer();\
}
...
#define XSENS_SetOutputConfiguration_ID 0xC0
#define XSENS_SetOutputConfiguration() { \
  XsensHeader(XSENS_SetOutputConfiguration_ID, 0);\
  XsensTrailer();\
}
...
#define XSENS_MTData2_ID 0x36
/* XSENS_MTData2_data: variable data size */
...
#define XSENS_ReqLeverArmGps_ID 0x68
#define XSENS_ReqLeverArmGps() { \
  XsensHeader(XSENS_ReqLeverArmGps_ID, 0);\
  XsensTrailer();\
}
#define XSENS_SetLeverArmGps_ID 0x68
#define XSENS_SetLeverArmGps(x,y,z) { \
  XsensHeader(XSENS_SetLeverArmGps_ID, 12);\
  float _x = x; XsensSend4ByAddr((uint8_t*)&_x);\
  float _y = y; XsensSend4ByAddr((uint8_t*)&_y);\
  float _z = z; XsensSend4ByAddr((uint8_t*)&_z);\
  XsensTrailer();\
}
#define XSENS_ReqLeverArmGpsAck_ID 0x69
#define XSENS_ReqLeverArmGpsAck_x(_xsens_payload) ({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_xsens_payload+3+0)|*((uint8_t*)_xsens_payload+2+0)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+0))<<16|((uint32_t)*((uint8_t*)_xsens_payload+0))<<24); _f.f; })
#define XSENS_ReqLeverArmGpsAck_y(_xsens_payload) ({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_xsens_payload+3+4)|*((uint8_t*)_xsens_payload+2+4)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+4))<<16|((uint32_t)*((uint8_t*)_xsens_payload+4))<<24); _f.f; })
#define XSENS_ReqLeverArmGpsAck_z(_xsens_payload) ({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_xsens_payload+3+8)|*((uint8_t*)_xsens_payload+2+8)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+8))<<16|((uint32_t)*((uint8_t*)_xsens_payload+8))<<24); _f.f; })
...
#define XSENS_DATA_UTC_LENGTH 12
#define XSENS_DATA_UTC_nanosec(_xsens_payload,_xsens_block) (uint32_t)(*((uint8_t*)_xsens_payload+3+0+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+0+1*_xsens_block)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+0+1*_xsens_block))<<16|((uint32_t)*((uint8_t*)_xsens_payload+0+1*_xsens_block))<<24)
#define XSENS_DATA_UTC_year(_xsens_payload,_xsens_block) (uint16_t)(*((uint8_t*)_xsens_payload+1+4+1*_xsens_block)|*((uint8_t*)_xsens_payload+4+1*_xsens_block)<<8)
#define XSENS_DATA_UTC_month(_xsens_payload,_xsens_block) (uint8_t)(*((uint8_t*)_xsens_payload+6+1*_xsens_block))
#define XSENS_DATA_UTC_day(_xsens_payload,_xsens_block) (uint8_t)(*((uint8_t*)_xsens_payload+7+1*_xsens_block))
#define XSENS_DATA_UTC_hour(_xsens_payload,_xsens_block) (uint8_t)(*((uint8_t*)_xsens_payload+8+1*_xsens_block))
#define XSENS_DATA_UTC_min(_xsens_payload,_xsens_block) (uint8_t)(*((uint8_t*)_xsens_payload+9+1*_xsens_block))
#define XSENS_DATA_UTC_sec(_xsens_payload,_xsens_block) (uint8_t)(*((uint8_t*)_xsens_payload+10+1*_xsens_block))
#define XSENS_DATA_UTC_valid(_xsens_payload,_xsens_block) (uint8_t)(*((uint8_t*)_xsens_payload+11+1*_xsens_block))

#define XSENS_DATA_RateOfTurn_LENGTH 12
#define XSENS_DATA_RateOfTurn_x(_xsens_payload,_xsens_block) ({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_xsens_payload+3+0+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+0+1*_xsens_block)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+0+1*_xsens_block))<<16|((uint32_t)*((uint8_t*)_xsens_payload+0+1*_xsens_block))<<24); _f.f; })
#define XSENS_DATA_RateOfTurn_y(_xsens_payload,_xsens_block) ({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_xsens_payload+3+4+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+4+1*_xsens_block)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+4+1*_xsens_block))<<16|((uint32_t)*((uint8_t*)_xsens_payload+4+1*_xsens_block))<<24); _f.f; })
#define XSENS_DATA_RateOfTurn_z(_xsens_payload,_xsens_block) ({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_xsens_payload+3+8+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+8+1*_xsens_block)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+8+1*_xsens_block))<<16|((uint32_t)*((uint8_t*)_xsens_payload+8+1*_xsens_block))<<24); _f.f; })

#define XSENS_DATA_Acceleration_LENGTH 12
#define XSENS_DATA_Acceleration_x(_xsens_payload,_xsens_block) ({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_xsens_payload+3+0+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+0+1*_xsens_block)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+0+1*_xsens_block))<<16|((uint32_t)*((uint8_t*)_xsens_payload+0+1*_xsens_block))<<24); _f.f; })
#define XSENS_DATA_Acceleration_y(_xsens_payload,_xsens_block) ({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_xsens_payload+3+4+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+4+1*_xsens_block)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+4+1*_xsens_block))<<16|((uint32_t)*((uint8_t*)_xsens_payload+4+1*_xsens_block))<<24); _f.f; })
#define XSENS_DATA_Acceleration_z(_xsens_payload,_xsens_block) ({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_xsens_payload+3+8+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+8+1*_xsens_block)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+8+1*_xsens_block))<<16|((uint32_t)*((uint8_t*)_xsens_payload+8+1*_xsens_block))<<24); _f.f; })

#define XSENS_XDI_GpsSvInfo_ID 88A0
#define XSENS_XDI_GpsSvInfo_iTOW(_xsens_payload) (uint32_t)(*((uint8_t*)_xsens_payload+3+0)|*((uint8_t*)_xsens_payload+2+0)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+0))<<16|((uint32_t)*((uint8_t*)_xsens_payload+0))<<24)
#define XSENS_XDI_GpsSvInfo_nch(_xsens_payload) (uint8_t)(*((uint8_t*)_xsens_payload+4))
#define XSENS_XDI_GpsSvInfo_res1(_xsens_payload) (uint8_t)(*((uint8_t*)_xsens_payload+5))
#define XSENS_XDI_GpsSvInfo_res2(_xsens_payload) (uint16_t)(*((uint8_t*)_xsens_payload+1+6)|*((uint8_t*)_xsens_payload+6)<<8)
#define XSENS_XDI_GpsSvInfo_chn(_xsens_payload,_xsens_block) (uint8_t)(*((uint8_t*)_xsens_payload+8+12*_xsens_block))
#define XSENS_XDI_GpsSvInfo_svid(_xsens_payload,_xsens_block) (uint8_t)(*((uint8_t*)_xsens_payload+9+12*_xsens_block))
#define XSENS_XDI_GpsSvInfo_bitmask(_xsens_payload,_xsens_block) (uint8_t)(*((uint8_t*)_xsens_payload+10+12*_xsens_block))
#define XSENS_XDI_GpsSvInfo_qi(_xsens_payload,_xsens_block) (uint8_t)(*((uint8_t*)_xsens_payload+11+12*_xsens_block))
#define XSENS_XDI_GpsSvInfo_cnr(_xsens_payload,_xsens_block) (uint8_t)(*((uint8_t*)_xsens_payload+12+12*_xsens_block))
#define XSENS_XDI_GpsSvInfo_elev(_xsens_payload,_xsens_block) (int8_t)(*((uint8_t*)_xsens_payload+13+12*_xsens_block))
#define XSENS_XDI_GpsSvInfo_azim(_xsens_payload,_xsens_block) (int16_t)(*((uint8_t*)_xsens_payload+1+14+12*_xsens_block)|*((uint8_t*)_xsens_payload+14+12*_xsens_block)<<8)
#define XSENS_XDI_GpsSvInfo_prRes(_xsens_payload,_xsens_block) (int32_t)(*((uint8_t*)_xsens_payload+3+16+12*_xsens_block)|*((uint8_t*)_xsens_payload+2+16+12*_xsens_block)<<8|((int32_t)*((uint8_t*)_xsens_payload+1+16+12*_xsens_block))<<16|((int32_t)*((uint8_t*)_xsens_payload+16+12*_xsens_block))<<24)

#define XSENS_DATA_GpsSol_LENGTH 49
#define XSENS_DATA_GpsSol_iTOW(_xsens_payload,_xsens_block) (uint32_t)(*((uint8_t*)_xsens_payload+3+0+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+0+1*_xsens_block)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+0+1*_xsens_block))<<16|((uint32_t)*((uint8_t*)_xsens_payload+0+1*_xsens_block))<<24)
#define XSENS_DATA_GpsSol_fTOW(_xsens_payload,_xsens_block) (int32_t)(*((uint8_t*)_xsens_payload+3+4+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+4+1*_xsens_block)<<8|((int32_t)*((uint8_t*)_xsens_payload+1+4+1*_xsens_block))<<16|((int32_t)*((uint8_t*)_xsens_payload+4+1*_xsens_block))<<24)
#define XSENS_DATA_GpsSol_week(_xsens_payload,_xsens_block) (int16_t)(*((uint8_t*)_xsens_payload+1+8+1*_xsens_block)|*((uint8_t*)_xsens_payload+8+1*_xsens_block)<<8)
#define XSENS_DATA_GpsSol_fix(_xsens_payload,_xsens_block) (uint8_t)(*((uint8_t*)_xsens_payload+10+1*_xsens_block))
#define XSENS_DATA_GpsSol_flags(_xsens_payload,_xsens_block) (uint8_t)(*((uint8_t*)_xsens_payload+11+1*_xsens_block))
#define XSENS_DATA_GpsSol_ecef_x(_xsens_payload,_xsens_block) (int32_t)(*((uint8_t*)_xsens_payload+3+12+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+12+1*_xsens_block)<<8|((int32_t)*((uint8_t*)_xsens_payload+1+12+1*_xsens_block))<<16|((int32_t)*((uint8_t*)_xsens_payload+12+1*_xsens_block))<<24)
#define XSENS_DATA_GpsSol_ecef_y(_xsens_payload,_xsens_block) (int32_t)(*((uint8_t*)_xsens_payload+3+16+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+16+1*_xsens_block)<<8|((int32_t)*((uint8_t*)_xsens_payload+1+16+1*_xsens_block))<<16|((int32_t)*((uint8_t*)_xsens_payload+16+1*_xsens_block))<<24)
#define XSENS_DATA_GpsSol_ecef_z(_xsens_payload,_xsens_block) (int32_t)(*((uint8_t*)_xsens_payload+3+20+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+20+1*_xsens_block)<<8|((int32_t)*((uint8_t*)_xsens_payload+1+20+1*_xsens_block))<<16|((int32_t)*((uint8_t*)_xsens_payload+20+1*_xsens_block))<<24)
#define XSENS_DATA_GpsSol_pAcc(_xsens_payload,_xsens_block) (uint32_t)(*((uint8_t*)_xsens_payload+3+24+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+24+1*_xsens_block)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+24+1*_xsens_block))<<16|((uint32_t)*((uint8_t*)_xsens_payload+24+1*_xsens_block))<<24)
#define XSENS_DATA_GpsSol_ecef_vx(_xsens_payload,_xsens_block) (int32_t)(*((uint8_t*)_xsens_payload+3+28+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+28+1*_xsens_block)<<8|((int32_t)*((uint8_t*)_xsens_payload+1+28+1*_xsens_block))<<16|((int32_t)*((uint8_t*)_xsens_payload+28+1*_xsens_block))<<24)
#define XSENS_DATA_GpsSol_ecef_vy(_xsens_payload,_xsens_block) (int32_t)(*((uint8_t*)_xsens_payload+3+32+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+32+1*_xsens_block)<<8|((int32_t)*((uint8_t*)_xsens_payload+1+32+1*_xsens_block))<<16|((int32_t)*((uint8_t*)_xsens_payload+32+1*_xsens_block))<<24)
#define XSENS_DATA_GpsSol_ecef_vz(_xsens_payload,_xsens_block) (int32_t)(*((uint8_t*)_xsens_payload+3+36+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+36+1*_xsens_block)<<8|((int32_t)*((uint8_t*)_xsens_payload+1+36+1*_xsens_block))<<16|((int32_t)*((uint8_t*)_xsens_payload+36+1*_xsens_block))<<24)
#define XSENS_DATA_GpsSol_sAcc(_xsens_payload,_xsens_block) (uint32_t)(*((uint8_t*)_xsens_payload+3+40+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+40+1*_xsens_block)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+40+1*_xsens_block))<<16|((uint32_t)*((uint8_t*)_xsens_payload+40+1*_xsens_block))<<24)
#define XSENS_DATA_GpsSol_pDop(_xsens_payload,_xsens_block) (uint16_t)(*((uint8_t*)_xsens_payload+1+44+1*_xsens_block)|*((uint8_t*)_xsens_payload+44+1*_xsens_block)<<8)
#define XSENS_DATA_GpsSol_res1(_xsens_payload,_xsens_block) (uint8_t)(*((uint8_t*)_xsens_payload+46+1*_xsens_block))
#define XSENS_DATA_GpsSol_numSv(_xsens_payload,_xsens_block) (uint8_t)(*((uint8_t*)_xsens_payload+47+1*_xsens_block))
#define XSENS_DATA_GpsSol_res2(_xsens_payload,_xsens_block) (uint8_t)(*((uint8_t*)_xsens_payload+48+1*_xsens_block))

#define XSENS_DATA_StatusWord_LENGTH 4
#define XSENS_DATA_StatusWord_status(_xsens_payload,_xsens_block) (uint32_t)(*((uint8_t*)_xsens_payload+3+0+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+0+1*_xsens_block)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+0+1*_xsens_block))<<16|((uint32_t)*((uint8_t*)_xsens_payload+0+1*_xsens_block))<<24)

#define XSENS_DATA_LatLon_LENGTH 8
#define XSENS_DATA_LatLon_lat(_xsens_payload,_xsens_block) ({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_xsens_payload+3+0+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+0+1*_xsens_block)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+0+1*_xsens_block))<<16|((uint32_t)*((uint8_t*)_xsens_payload+0+1*_xsens_block))<<24); _f.f; })
#define XSENS_DATA_LatLon_lon(_xsens_payload,_xsens_block) ({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_xsens_payload+3+4+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+4+1*_xsens_block)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+4+1*_xsens_block))<<16|((uint32_t)*((uint8_t*)_xsens_payload+4+1*_xsens_block))<<24); _f.f; })

#define XSENS_DATA_Altitude_LENGTH 4
#define XSENS_DATA_Altitude_h(_xsens_payload,_xsens_block) ({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_xsens_payload+3+0+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+0+1*_xsens_block)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+0+1*_xsens_block))<<16|((uint32_t)*((uint8_t*)_xsens_payload+0+1*_xsens_block))<<24); _f.f; })

#define XSENS_DATA_VelocityXYZ_LENGTH 12
#define XSENS_DATA_VelocityXYZ_x(_xsens_payload,_xsens_block) ({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_xsens_payload+3+0+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+0+1*_xsens_block)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+0+1*_xsens_block))<<16|((uint32_t)*((uint8_t*)_xsens_payload+0+1*_xsens_block))<<24); _f.f; })
#define XSENS_DATA_VelocityXYZ_y(_xsens_payload,_xsens_block) ({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_xsens_payload+3+4+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+4+1*_xsens_block)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+4+1*_xsens_block))<<16|((uint32_t)*((uint8_t*)_xsens_payload+4+1*_xsens_block))<<24); _f.f; })
#define XSENS_DATA_VelocityXYZ_z(_xsens_payload,_xsens_block) ({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_xsens_payload+3+8+1*_xsens_block)|*((uint8_t*)_xsens_payload+2+8+1*_xsens_block)<<8|((uint32_t)*((uint8_t*)_xsens_payload+1+8+1*_xsens_block))<<16|((uint32_t)*((uint8_t*)_xsens_payload+8+1*_xsens_block))<<24); _f.f; })
...
#define XSENS_MASK_TimeStamp(_conf) ((_conf & 0x00000001))

#define XSENS_MASK_UTC(_conf) ((_conf & 0x00000002))

#define XSENS_MASK_OrientationMode(_conf) ((_conf & 0x0000000C)>>2)
