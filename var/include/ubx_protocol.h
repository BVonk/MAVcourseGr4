/* Generated by gen_ubx from /home/bart/paparazzi/conf/ubx.xml */
/* Please DO NOT EDIT */
...
#define UBX_NAV_SOL_Frac(_ubx_payload) (int32_t)(*((uint8_t*)_ubx_payload+4)|(int32_t)(*((uint8_t*)_ubx_payload+1+4))<<8|((int32_t)*((uint8_t*)_ubx_payload+2+4))<<16|((int32_t)*((uint8_t*)_ubx_payload+3+4))<<24)
...
#define UBX_NAV_SOL_ECEF_X(_ubx_payload) (int32_t)(*((uint8_t*)_ubx_payload+12)|(int32_t)(*((uint8_t*)_ubx_payload+1+12))<<8|((int32_t)*((uint8_t*)_ubx_payload+2+12))<<16|((int32_t)*((uint8_t*)_ubx_payload+3+12))<<24)
#define UBX_NAV_SOL_ECEF_Y(_ubx_payload) (int32_t)(*((uint8_t*)_ubx_payload+16)|(int32_t)(*((uint8_t*)_ubx_payload+1+16))<<8|((int32_t)*((uint8_t*)_ubx_payload+2+16))<<16|((int32_t)*((uint8_t*)_ubx_payload+3+16))<<24)
#define UBX_NAV_SOL_ECEF_Z(_ubx_payload) (int32_t)(*((uint8_t*)_ubx_payload+20)|(int32_t)(*((uint8_t*)_ubx_payload+1+20))<<8|((int32_t)*((uint8_t*)_ubx_payload+2+20))<<16|((int32_t)*((uint8_t*)_ubx_payload+3+20))<<24)
...
#define UBX_NAV_SOL_res2(_ubx_payload) (uint32_t)(*((uint8_t*)_ubx_payload+48)|(uint32_t)(*((uint8_t*)_ubx_payload+1+48))<<8|((uint32_t)*((uint8_t*)_ubx_payload+2+48))<<16|((uint32_t)*((uint8_t*)_ubx_payload+3+48))<<24)
...
#define UBX_NAV_VELNED_VEL_N(_ubx_payload) (int32_t)(*((uint8_t*)_ubx_payload+4)|(int32_t)(*((uint8_t*)_ubx_payload+1+4))<<8|((int32_t)*((uint8_t*)_ubx_payload+2+4))<<16|((int32_t)*((uint8_t*)_ubx_payload+3+4))<<24)
#define UBX_NAV_VELNED_VEL_E(_ubx_payload) (int32_t)(*((uint8_t*)_ubx_payload+8)|(int32_t)(*((uint8_t*)_ubx_payload+1+8))<<8|((int32_t)*((uint8_t*)_ubx_payload+2+8))<<16|((int32_t)*((uint8_t*)_ubx_payload+3+8))<<24)
#define UBX_NAV_VELNED_VEL_D(_ubx_payload) (int32_t)(*((uint8_t*)_ubx_payload+12)|(int32_t)(*((uint8_t*)_ubx_payload+1+12))<<8|((int32_t)*((uint8_t*)_ubx_payload+2+12))<<16|((int32_t)*((uint8_t*)_ubx_payload+3+12))<<24)
...
#define UBX_NAV_SVINFO_RES2(_ubx_payload) (uint16_t)(*((uint8_t*)_ubx_payload+6)|(uint16_t)(*((uint8_t*)_ubx_payload+1+6))<<8)
...
#define UBX_NAV_HPPOSECEF_RES1(_ubx_payload) (uint16_t)(*((uint8_t*)_ubx_payload+1)|(uint16_t)(*((uint8_t*)_ubx_payload+1+1))<<8)
#define UBX_NAV_HPPOSECEF_RES2(_ubx_payload) (uint8_t)(*((uint8_t*)_ubx_payload+3))
...
#define UBX_NAV_HPPOSECEF_ECEF_X(_ubx_payload) (int32_t)(*((uint8_t*)_ubx_payload+8)|(int32_t)(*((uint8_t*)_ubx_payload+1+8))<<8|((int32_t)*((uint8_t*)_ubx_payload+2+8))<<16|((int32_t)*((uint8_t*)_ubx_payload+3+8))<<24)
#define UBX_NAV_HPPOSECEF_ECEF_Y(_ubx_payload) (int32_t)(*((uint8_t*)_ubx_payload+12)|(int32_t)(*((uint8_t*)_ubx_payload+1+12))<<8|((int32_t)*((uint8_t*)_ubx_payload+2+12))<<16|((int32_t)*((uint8_t*)_ubx_payload+3+12))<<24)
#define UBX_NAV_HPPOSECEF_ECEF_Z(_ubx_payload) (int32_t)(*((uint8_t*)_ubx_payload+16)|(int32_t)(*((uint8_t*)_ubx_payload+1+16))<<8|((int32_t)*((uint8_t*)_ubx_payload+2+16))<<16|((int32_t)*((uint8_t*)_ubx_payload+3+16))<<24)
#define UBX_NAV_HPPOSECEF_ECEF_XHP(_ubx_payload) (int8_t)(*((uint8_t*)_ubx_payload+20))
#define UBX_NAV_HPPOSECEF_ECEF_YHP(_ubx_payload) (int8_t)(*((uint8_t*)_ubx_payload+21))
#define UBX_NAV_HPPOSECEF_ECEF_ZHP(_ubx_payload) (int8_t)(*((uint8_t*)_ubx_payload+22))
#define UBX_NAV_HPPOSECEF_RES3(_ubx_payload) (uint8_t)(*((uint8_t*)_ubx_payload+23))
...
static inline void UbxSend_NAV_HPPOSECEF(struct link_device *dev, uint8_t ubx_version, uint16_t ubx_res1, uint8_t ubx_res2, uint32_t ubx_itow, int32_t ubx_ecef_x, int32_t ubx_ecef_y, int32_t ubx_ecef_z, int8_t ubx_ecef_xhp, int8_t ubx_ecef_yhp, int8_t ubx_ecef_zhp, uint8_t ubx_res3, uint32_t ubx_pacc) {
  ...
  int32_t _ecef_y = ubx_ecef_y; ubx_send_bytes(dev, 4, (uint8_t*)&_ecef_y);
  int32_t _ecef_z = ubx_ecef_z; ubx_send_bytes(dev, 4, (uint8_t*)&_ecef_z);
  int8_t _ecef_xhp = ubx_ecef_xhp; ubx_send_bytes(dev, 1, (uint8_t*)&_ecef_xhp);
  int8_t _ecef_yhp = ubx_ecef_yhp; ubx_send_bytes(dev, 1, (uint8_t*)&_ecef_yhp);
  int8_t _ecef_zhp = ubx_ecef_zhp; ubx_send_bytes(dev, 1, (uint8_t*)&_ecef_zhp);
...
#define UBX_NAV_HPPOSLLH_RES1(_ubx_payload) (uint16_t)(*((uint8_t*)_ubx_payload+1)|(uint16_t)(*((uint8_t*)_ubx_payload+1+1))<<8)
#define UBX_NAV_HPPOSLLH_RES2(_ubx_payload) (uint8_t)(*((uint8_t*)_ubx_payload+3))
...
static inline void UbxSend_NAV_HPPOSLLH(struct link_device *dev, uint8_t ubx_version, uint16_t ubx_res1, uint8_t ubx_res2, uint32_t ubx_itow, int32_t ubx_lon, int32_t ubx_lat, int32_t ubx_height, int32_t ubx_hmsl, int8_t ubx_lonhp, int8_t ubx_lathp, int8_t ubx_heighthp, int8_t ubx_hmslhp, uint32_t ubx_hacc, uint32_t ubx_vacc) {
...
#define UBX_NAV_RELPOSNED_RES1(_ubx_payload) (uint8_t)(*((uint8_t*)_ubx_payload+1))
...
#define UBX_NAV_RELPOSNED_RELPOSNHP(_ubx_payload) (int8_t)(*((uint8_t*)_ubx_payload+20))
#define UBX_NAV_RELPOSNED_RELPOSEHP(_ubx_payload) (int8_t)(*((uint8_t*)_ubx_payload+21))
#define UBX_NAV_RELPOSNED_RELPOSDHP(_ubx_payload) (int8_t)(*((uint8_t*)_ubx_payload+22))
#define UBX_NAV_RELPOSNED_RES2(_ubx_payload) (uint8_t)(*((uint8_t*)_ubx_payload+23))
#define UBX_NAV_RELPOSNED_Nacc(_ubx_payload) (uint32_t)(*((uint8_t*)_ubx_payload+24)|(uint32_t)(*((uint8_t*)_ubx_payload+1+24))<<8|((uint32_t)*((uint8_t*)_ubx_payload+2+24))<<16|((uint32_t)*((uint8_t*)_ubx_payload+3+24))<<24)
#define UBX_NAV_RELPOSNED_Eacc(_ubx_payload) (uint32_t)(*((uint8_t*)_ubx_payload+28)|(uint32_t)(*((uint8_t*)_ubx_payload+1+28))<<8|((uint32_t)*((uint8_t*)_ubx_payload+2+28))<<16|((uint32_t)*((uint8_t*)_ubx_payload+3+28))<<24)
#define UBX_NAV_RELPOSNED_Dacc(_ubx_payload) (uint32_t)(*((uint8_t*)_ubx_payload+32)|(uint32_t)(*((uint8_t*)_ubx_payload+1+32))<<8|((uint32_t)*((uint8_t*)_ubx_payload+2+32))<<16|((uint32_t)*((uint8_t*)_ubx_payload+3+32))<<24)
#define UBX_NAV_RELPOSNED_Flags(_ubx_payload) (uint32_t)(*((uint8_t*)_ubx_payload+36)|(uint32_t)(*((uint8_t*)_ubx_payload+1+36))<<8|((uint32_t)*((uint8_t*)_ubx_payload+2+36))<<16|((uint32_t)*((uint8_t*)_ubx_payload+3+36))<<24)

static inline void UbxSend_NAV_RELPOSNED(struct link_device *dev, uint8_t ubx_version, uint8_t ubx_res1, uint16_t ubx_refstationid, uint32_t ubx_itow, int32_t ubx_relposn, int32_t ubx_relpose, int32_t ubx_relposd, int8_t ubx_relposnhp, int8_t ubx_relposehp, int8_t ubx_relposdhp, uint8_t ubx_res2, uint32_t ubx_nacc, uint32_t ubx_eacc, uint32_t ubx_dacc, uint32_t ubx_flags) {
  ubx_header(dev, UBX_NAV_ID, UBX_NAV_RELPOSNED_ID, 40);
  uint8_t _version = ubx_version; ubx_send_bytes(dev, 1, (uint8_t*)&_version);
  uint8_t _res1 = ubx_res1; ubx_send_bytes(dev, 1, (uint8_t*)&_res1);
  ...
  int8_t _relposnhp = ubx_relposnhp; ubx_send_bytes(dev, 1, (uint8_t*)&_relposnhp);
  int8_t _relposehp = ubx_relposehp; ubx_send_bytes(dev, 1, (uint8_t*)&_relposehp);
  int8_t _relposdhp = ubx_relposdhp; ubx_send_bytes(dev, 1, (uint8_t*)&_relposdhp);
  uint8_t _res2 = ubx_res2; ubx_send_bytes(dev, 1, (uint8_t*)&_res2);
  uint32_t _nacc = ubx_nacc; ubx_send_bytes(dev, 4, (uint8_t*)&_nacc);
  uint32_t _eacc = ubx_eacc; ubx_send_bytes(dev, 4, (uint8_t*)&_eacc);
  uint32_t _dacc = ubx_dacc; ubx_send_bytes(dev, 4, (uint8_t*)&_dacc);
...
#define UBX_CFG_NAV5_dDop(_ubx_payload) (uint16_t)(*((uint8_t*)_ubx_payload+14)|(uint16_t)(*((uint8_t*)_ubx_payload+1+14))<<8)
...
#define UBX_CFG_NAV5_res2(_ubx_payload) (uint32_t)(*((uint8_t*)_ubx_payload+24)|(uint32_t)(*((uint8_t*)_ubx_payload+1+24))<<8|((uint32_t)*((uint8_t*)_ubx_payload+2+24))<<16|((uint32_t)*((uint8_t*)_ubx_payload+3+24))<<24)
#define UBX_CFG_NAV5_res3(_ubx_payload) (uint32_t)(*((uint8_t*)_ubx_payload+28)|(uint32_t)(*((uint8_t*)_ubx_payload+1+28))<<8|((uint32_t)*((uint8_t*)_ubx_payload+2+28))<<16|((uint32_t)*((uint8_t*)_ubx_payload+3+28))<<24)
#define UBX_CFG_NAV5_res4(_ubx_payload) (uint32_t)(*((uint8_t*)_ubx_payload+32)|(uint32_t)(*((uint8_t*)_ubx_payload+1+32))<<8|((uint32_t)*((uint8_t*)_ubx_payload+2+32))<<16|((uint32_t)*((uint8_t*)_ubx_payload+3+32))<<24)
...
#define UBX_CFG_NAV5_HPG_ID 0x24
#define UBX_CFG_NAV5_HPG_mask(_ubx_payload) (uint16_t)(*((uint8_t*)_ubx_payload+0)|(uint16_t)(*((uint8_t*)_ubx_payload+1+0))<<8)
#define UBX_CFG_NAV5_HPG_dynModel(_ubx_payload) (uint8_t)(*((uint8_t*)_ubx_payload+2))
#define UBX_CFG_NAV5_HPG_fixModel(_ubx_payload) (uint8_t)(*((uint8_t*)_ubx_payload+3))
#define UBX_CFG_NAV5_HPG_fixedAlt(_ubx_payload) (int32_t)(*((uint8_t*)_ubx_payload+4)|(int32_t)(*((uint8_t*)_ubx_payload+1+4))<<8|((int32_t)*((uint8_t*)_ubx_payload+2+4))<<16|((int32_t)*((uint8_t*)_ubx_payload+3+4))<<24)
#define UBX_CFG_NAV5_HPG_fixedAltVar(_ubx_payload) (uint32_t)(*((uint8_t*)_ubx_payload+8)|(uint32_t)(*((uint8_t*)_ubx_payload+1+8))<<8|((uint32_t)*((uint8_t*)_ubx_payload+2+8))<<16|((uint32_t)*((uint8_t*)_ubx_payload+3+8))<<24)
#define UBX_CFG_NAV5_HPG_minElev(_ubx_payload) (int8_t)(*((uint8_t*)_ubx_payload+12))
#define UBX_CFG_NAV5_HPG_drLimit(_ubx_payload) (uint8_t)(*((uint8_t*)_ubx_payload+13))
#define UBX_CFG_NAV5_HPG_dDop(_ubx_payload) (uint16_t)(*((uint8_t*)_ubx_payload+14)|(uint16_t)(*((uint8_t*)_ubx_payload+1+14))<<8)
#define UBX_CFG_NAV5_HPG_tDop(_ubx_payload) (uint16_t)(*((uint8_t*)_ubx_payload+16)|(uint16_t)(*((uint8_t*)_ubx_payload+1+16))<<8)
#define UBX_CFG_NAV5_HPG_pAcc(_ubx_payload) (uint16_t)(*((uint8_t*)_ubx_payload+18)|(uint16_t)(*((uint8_t*)_ubx_payload+1+18))<<8)
#define UBX_CFG_NAV5_HPG_tAcc(_ubx_payload) (uint16_t)(*((uint8_t*)_ubx_payload+20)|(uint16_t)(*((uint8_t*)_ubx_payload+1+20))<<8)
#define UBX_CFG_NAV5_HPG_staticHoldThresh(_ubx_payload) (uint8_t)(*((uint8_t*)_ubx_payload+22))
#define UBX_CFG_NAV5_HPG_dgnssTimeout(_ubx_payload) (uint8_t)(*((uint8_t*)_ubx_payload+23))
#define UBX_CFG_NAV5_HPG_cnoThreshNumSVs(_ubx_payload) (uint8_t)(*((uint8_t*)_ubx_payload+24))
#define UBX_CFG_NAV5_HPG_cnoThresh(_ubx_payload) (uint8_t)(*((uint8_t*)_ubx_payload+25))
#define UBX_CFG_NAV5_HPG_res1(_ubx_payload) (uint16_t)(*((uint8_t*)_ubx_payload+26)|(uint16_t)(*((uint8_t*)_ubx_payload+1+26))<<8)
#define UBX_CFG_NAV5_HPG_staticHoldMaxDist(_ubx_payload) (uint16_t)(*((uint8_t*)_ubx_payload+28)|(uint16_t)(*((uint8_t*)_ubx_payload+1+28))<<8)
#define UBX_CFG_NAV5_HPG_utcStandard(_ubx_payload) (uint8_t)(*((uint8_t*)_ubx_payload+30))
#define UBX_CFG_NAV5_HPG_res2(_ubx_payload) (uint32_t)(*((uint8_t*)_ubx_payload+31)|(uint32_t)(*((uint8_t*)_ubx_payload+1+31))<<8|((uint32_t)*((uint8_t*)_ubx_payload+2+31))<<16|((uint32_t)*((uint8_t*)_ubx_payload+3+31))<<24)
#define UBX_CFG_NAV5_HPG_res3(_ubx_payload) (uint8_t)(*((uint8_t*)_ubx_payload+35))

static inline void UbxSend_CFG_NAV5_HPG(struct link_device *dev, uint16_t ubx_mask, uint8_t ubx_dynmodel, uint8_t ubx_fixmodel, int32_t ubx_fixedalt, uint32_t ubx_fixedaltvar, int8_t ubx_minelev, uint8_t ubx_drlimit, uint16_t ubx_ddop, uint16_t ubx_tdop, uint16_t ubx_pacc, uint16_t ubx_tacc, uint8_t ubx_staticholdthresh, uint8_t ubx_dgnsstimeout, uint8_t ubx_cnothreshnumsvs, uint8_t ubx_cnothresh, uint16_t ubx_res1, uint16_t ubx_staticholdmaxdist, uint8_t ubx_utcstandard, uint32_t ubx_res2, uint8_t ubx_res3) {
  ubx_header(dev, UBX_CFG_ID, UBX_CFG_NAV5_HPG_ID, 36);
  uint16_t _mask = ubx_mask; ubx_send_bytes(dev, 2, (uint8_t*)&_mask);
  uint8_t _dynmodel = ubx_dynmodel; ubx_send_bytes(dev, 1, (uint8_t*)&_dynmodel);
  uint8_t _fixmodel = ubx_fixmodel; ubx_send_bytes(dev, 1, (uint8_t*)&_fixmodel);
  int32_t _fixedalt = ubx_fixedalt; ubx_send_bytes(dev, 4, (uint8_t*)&_fixedalt);
